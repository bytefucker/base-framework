...
public final class DateUtil {
  ...
  public static final String ERROR_FORMAT = "解析日期字符串出错！格式：{}";
  public static final String ERROR_DATETIME_FORMAT = "解析日期字符串:%s 为：%s出错！";
  ...
  public static Date parseDatetime(String str) {
    return SIMPLE_DATETIME_FORMAT.get().parse(str);
  }
  ...
  /**
   * 解析时间 将使用1970-01-01 作为年份，使用时请注意
   *
   * @param str HH:mm:ss
   * @return Date
   */
  ...
  public static Date parseYMDTHMSZ(String dateStr) {
    ...
    return SIMPLE_YYYY_MM_DDTHH_MM_SSZ_FORMAT.get().parse(dateStr);
  }
  ...
  public static Date parseYMDTHMSSSZ(String dateStr) {
    ...
    return SIMPLE_YYYY_MM_DDTHH_MM_SS_SSSZ_FORMAT.get().parse(dateStr);
  }
}
